...
const ComingSoonPage = () => {
	return (
		<div className="flex items-start justify-center lg:justify-normal lg:mx-20 w-full h-auto bg-white mt-6">

			<div className="max-w-xs md:max-w-xl lg:max-w-2xl text-center px-6 py-6 lg:px-20 mx-2 bg-white shadow-md rounded-lg">
